...
$page_title = 'Administrative Password Change';
$display_title = 'Administrative Password Change';
...
?>
	...
	<article class="page">
		<header class="entry-header">
			<h1 class="entry-title"><?php print $display_title; ?></h1>
		</header>
...
<?php
	...
	if ( $status ) {
		...
		include_once('../inc/form-admin-success.php');
		
	} else {
	
		include_once('../inc/form-admin.php');
